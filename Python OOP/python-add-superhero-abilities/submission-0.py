class SuperHero:
    ...
    def attack(self):
        print("{name} attacks with {power}!".format(name=self.name, power=self.power))
    # TODO: Define heal method and implment it
    def heal(self):
        self.health += 10
        print("{name} heals 10 points. New health: {health}.".format(name=self.name, health=self.health))
